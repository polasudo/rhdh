...
+ 
```
./build/scripts/triggerRespin.sh -v 1.6 hub # respin hub
./build/scripts/triggerRespin.sh -v 1.6 hub,op # respin hub and operator
./build/scripts/triggerRespin.sh -v 1.6 op # respin operator
