...
====
NOTE: As of 1.3.5, we've been asked to use RHSA instead of RHBA when creating erratas. HOWEVER, a **Product Security Approval Request** IS NOT REQUIRED. 
====
...
NOTE: Repo branching for pkgs.devel is manual, but the script will tell you what to run!
...
.. [ ] https://pkgs.devel.redhat.com/cgit/containers/rhdh-hub/tree/?h=rhdh-1.3-rhel-9
.. [ ] https://pkgs.devel.redhat.com/cgit/containers/rhdh-operator/tree/?h=rhdh-1.3-rhel-9
.. [ ] https://pkgs.devel.redhat.com/cgit/containers/rhdh-operator-bundle/tree/?h=rhdh-1.3-rhel-9
...
.. helm chart from https://github.com/rhdh-bot/openshift-helm-charts/tree/rhdh-1-rhel-9/installation#installation and https://github.com/rhdh-bot/openshift-helm-charts/tree/rhdh-1.3-rhel-9/installation#installation
.. operator install from https://gitlab.cee.redhat.com/rhidp/rhdh/-/blob/rhdh-1-rhel-9/build/scripts/installCatalogSourceFromIIB.sh
+
[WARNING]
====
