...
. Release notes should be updated with a link to the latest RHBA or RHSA advisory. To find that link, use link:../build/scripts/getAdvisoryForCVE.sh[getAdvisoryForCVE.sh].
+
...
+
https://github.com/redhat-developer/red-hat-developers-documentation-rhdh/pull/1170/files
