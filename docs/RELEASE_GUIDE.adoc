...
./build/helm/prepare.sh --chart-version 1.1.2 --rhdh-version 1.1-107 --catalog git@github.com:rhdh-bot/openshift-helm-charts.git --publish
...
git remote add rhdh-bot git@github.com:rhdh-bot/openshift-helm-charts.git && git fetch rhdh-bot && git checkout release-1.1.2

# create a pull request from the release-x.y.z branch of rhdh-bot to the openshift main branch
export GITHUB_TOKEN=<your token here>
gh pr create --fill --base main --head release-1.1.2 -w
