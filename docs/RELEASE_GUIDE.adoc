...
*** For example: ./build/scripts/sendSlackNotifications.sh --version 1.y.z --bundle-tag 1.y-zzz --slack-webhook <slack-webhook-url> --release-state RC [optional: --dryrun]
**** [🍎 macOS_arm64]
...
* In future this may be done automatically. TODO: https://issues.redhat.com/browse/RHIDP-6305
