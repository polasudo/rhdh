...
Once the k-r-d MR is merged, Konflux will generate new pipelines in the `1.y` branch, which should be ignored and closed.
...
Now you can run the `./generatePipelineRunsForPlugins.sh` script in the `.tekton` folder of the rhdh-plugin-catalog repo.
