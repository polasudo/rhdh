...
. To push to production, all the image references in the FBCs must be for registry.redhat.io/rhdh, not quay.io/rhdh. Rebuild your FBCs with the --rhec flag to make this change automatically
