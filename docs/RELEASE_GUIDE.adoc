...
* [ ] Check for open PRs from `rhdh-bot` related to repo version bumps, base image updates, or RPM lock file updates:
  ** RHDH: link:https://github.com/redhat-developer/rhdh/pulls?q=is%3Aopen+is%3Apr+author%3Arhdh-bot[open PRs]
  ** RHDH Local: link:https://github.com/redhat-developer/rhdh-local/pulls?q=is%3Aopen+is%3Apr+author%3Arhdh-bot[open PRs]
  ** RHDH Chart: link:https://github.com/redhat-developer/rhdh-chart/pulls?q=is%3Aopen+is%3Apr+author%3Arhdh-bot[open PRs]
  ** RHDH Operator: link:https://github.com/redhat-developer/rhdh-operator/pulls?q=is%3Aopen+is%3Apr+author%3Arhdh-bot[open PRs]
