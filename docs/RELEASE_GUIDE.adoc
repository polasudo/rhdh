...
NOTE: Merge requests may fail if there are required changes to either of their dependent repos.

For reference here are the MRs for the 1.6 branch creation:
...
**TODO**: replace with links for 1.7 and rewrite this section to just summarize the steps.
