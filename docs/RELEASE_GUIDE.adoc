...
# for <=1.6, with support from OCP 4.14 to 4.19 GA + 4.20 CI
...
# for >=1.7, with support for OCP 4.19 GA + 4.20 CI; 4.15 removed; sealights support added
# list of OCP versions is set in ocp-versions.yaml
