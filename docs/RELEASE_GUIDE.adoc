...
# create pull request
./build/helm/prepare.sh --chart-version 1.2.2 --rhdh-version 1.2-132 --chart-branch 1.2.x --catalog git@github.com:rhdh-bot/openshift-helm-charts.git --publish
```

You should see something like this:
```
Create chart for 1.2-132 (1.2.2)
...
...
Chart version:        1.2.2
Developer Hub image:  registry.redhat.io/rhdh/rhdh-hub-rhel9:1.2-132
Branch:               https://github.com/rhdh-bot/openshift-helm-charts/tree/redhat-developer-hub-1.2.2
...
[release-1.2.2 daf0844] chore: chart: add Red Hat Developer 1.2.2 for registry.redhat.io/rhdh/rhdh-hub-rhel9:1.2-132
...
...
./build/scripts/copyIIBsToQuay.sh -t 1.2-121 --force --push --latest -e 1.2.2.GA
```
...
./build/scripts/tagRelease.sh -v 1.2.2 -t 1.2 -gh 1.2.x -pd rhdh-1.2-rhel-9 -ghtoken $GITHUB_TOKEN
