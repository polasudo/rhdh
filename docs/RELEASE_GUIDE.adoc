...
Submit PR to fix version reference in `upstream_repos.yml` for both the new rhdh-1.yy-rhel-9 branch.

NOTE: **_TODO_: RHIDP-931 script this so it's done when the new branch is created**
