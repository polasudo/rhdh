...
Script will create/update 1.y branches and update the main + rhdh-1-rhel-9 branches with minor version bumps.

### Brew Targets, Product Variants, and CPEs

This can be done any time before starting the feature/code frozen builds from the new 1.y branc, but it's better to do it in advance so your builds don't fail due to the missing brew target / PV.
