...
/path/to/gl/rhidp/rhdh/build/scripts/updateBaseImages.sh -b release-1.6 -w $(pwd) -f \*ockerfile -maxdepth 5 -o
...
+
```
[INFO] Bundle Version: rhdh-operator.v1.6.0
...
[INFO] Bundle Image Tag: quay.io/rhdh/rhdh-operator-bundle:1.6-161
[INFO] CSV contains:
quay.io/rhdh/rhdh-hub-rhel9:1.6-175
quay.io/rhdh/rhdh-rhel9-operator:1.6-93
registry.redhat.io/rhel9/postgresql-15:1-1741891035

quay.io/rhdh/rhdh-hub-rhel9:1.6-175
UPSTREAM_REPO=https://github.com/redhat-developer/rhdh/tree/release-1.6 @ 22737d02
MIDSTREAM_REPO=https://gitlab.cee.redhat.com/rhidp/rhdh/-/commits/rhdh-1.6-rhel-9

quay.io/rhdh/rhdh-rhel9-operator:1.6-93
UPSTREAM_REPO=https://github.com/redhat-developer/rhdh-operator/tree/release-1.6 @ 6ce061ee
MIDSTREAM_REPO=https://gitlab.cee.redhat.com/rhidp/rhdh/-/commits/rhdh-1.6-rhel-9

quay.io/rhdh/rhdh-operator-bundle:1.6-161
UPSTREAM_REPO=https://github.com/redhat-developer/rhdh-operator/tree/release-1.6 @ 6ce061ee
MIDSTREAM_REPO=https://gitlab.cee.redhat.com/rhidp/rhdh/-/commits/rhdh-1.6-rhel-9
```
+
...
./build/scripts/kfuxRelease.sh --stage -c rhdh-operator-bundle:1.6-zzz -v 1.6.2 --cve "/tmp/RHDH CVE Management - 1.6.2.csv" --issues RHIDP-7725,RHIDP-7726 [--debug]
```
...
./build/scripts/kfuxRelease.sh --prod  -c rhdh-operator-bundle:1.6-zzz -v 1.6.2 --cve "/tmp/RHDH CVE Management - 1.6.2.csv" --issues RHIDP-7725,RHIDP-7726 [--debug]
```
...
. Close the JIRA release, assuming all the issues are resolved. If not, go chase people or ask the Release Manager to chase them

. The list of unreleased versions is here: link:https://issues.redhat.com/projects/RHIDP?selectedItem=com.atlassian.jira.jira-projects-plugin%3Arelease-page&status=unreleased[RHIDP release-page].
