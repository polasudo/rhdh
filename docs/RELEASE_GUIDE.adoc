...
* copy the latest IIBs to quay.io/rhdh/iib using link:../build/scripts/renderCatalogs.sh[renderCatalogs] script
...
You can push a Release to Stage if you want for any/all RC snapshots.

See link:../build/scripts/kfuxRelease.sh[kfuxRelease.sh].
