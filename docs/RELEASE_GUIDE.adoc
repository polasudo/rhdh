...
* [ ] Check for open PRs from `rhdh-bot` related to repo version bumps, base image updates, or RPM lock file updates:
  ** RHDH: https://github.com/redhat-developer/rhdh/pulls?q=is%3Aopen+is%3Apr+author%3Arhdh-bot
  ** RHDH Local: https://github.com/redhat-developer/rhdh-local/pulls?q=is%3Aopen+is%3Apr+author%3Arhdh-bot
  ** RHDH Chart: https://github.com/redhat-developer/rhdh-chart/pulls?q=is%3Aopen+is%3Apr+author%3Arhdh-bot
  ** RHDH Operator: https://github.com/redhat-developer/rhdh-operator/pulls?q=is%3Aopen+is%3Apr+author%3Arhdh-bot
...
See <<post-ga-bot-pr-followup,Post-GA follow-up>> for the concrete consequences and what to verify after tagging.
====
...
====
+
. **IMPORTANT!** Once run, you can check for CHI grades in Comet - if you see anything lower than A, review the base images, RPM lock files, and fixable CVEs before announcing this RC is ready.
+
