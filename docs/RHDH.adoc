...
====
NOTE: There currently is no https://github.com/janus-idp/operator/tree/main/bundle[upstream operator-bundle]. link:https://gitlab.cee.redhat.com/rhidp/rhdh/-/tree/rhdh-1.1-rhel-9/distgit/containers/rhdh-operator-bundle[See midstream] and `(TODO)` https://issues.redhat.com/browse/RHIDP-488
====
...
* NOTE: there is no upstream operator-bundle. link:https://gitlab.cee.redhat.com/rhidp/rhdh/-/tree/rhdh-1.1-rhel-9/distgit/containers/rhdh-operator-bundle[See midstream].
