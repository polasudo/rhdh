...
```
+
. Log in to quay.io and registry.redhat.io, and use those tokens as pull secrets in your cluster -- see link:https://github.com/janus-idp/operator/blob/main/.rhdh/docs/installing-ci-builds.adoc[installing-ci-builds.adoc] for more on this and a scripted solution.
