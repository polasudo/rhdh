...
This needs to be executed from the root of the repository!!!

Examples:
  $0 cache distgit/containers/rhdh-hub
  $0 image distgit/containers/rhdh-hub quay.io/example/image:tag
