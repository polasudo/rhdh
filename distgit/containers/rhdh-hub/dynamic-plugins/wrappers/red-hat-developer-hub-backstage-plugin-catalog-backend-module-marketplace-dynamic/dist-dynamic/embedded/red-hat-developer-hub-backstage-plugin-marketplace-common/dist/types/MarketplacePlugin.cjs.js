...
function isMarketplacePlugin(entity) {
  return !!entity && (entity.apiVersion === consts.EXTENSIONS_API_VERSION || entity.apiVersion === "marketplace.backstage.io/v1alpha1") && entity.kind === MarketplaceKind.MarketplaceKind.Plugin;
}

exports.AssetType = AssetType;
exports.DocumentationType = DocumentationType;
exports.MarketplacePluginInstallStatus = MarketplacePluginInstallStatus;
exports.isMarketplacePlugin = isMarketplacePlugin;
//# sourceMappingURL=MarketplacePlugin.cjs.js.map
