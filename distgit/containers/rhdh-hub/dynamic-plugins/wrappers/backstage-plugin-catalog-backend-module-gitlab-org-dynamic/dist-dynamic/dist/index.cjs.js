...
GitlabDiscoveryEntityProvider.GitlabDiscoveryEntityProvider;
var GitlabOrgDiscoveryEntityProvider_1 = GitlabOrgDiscoveryEntityProvider;
    ...
    env.registerInit({
      ...
      async init({ config, catalog, logger, scheduler }) {
        catalog.addEntityProvider(
          GitlabOrgDiscoveryEntityProvider_1.fromConfig(config, {
            logger: require$$0$1.loggerToWinstonLogger(logger),
            scheduler
          })
        );
      }
